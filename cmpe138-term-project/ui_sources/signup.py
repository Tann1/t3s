...
# SignupUi_Form implementation generated from reading ui file 'loginUi3.ui'
#
...
from ui_sources.res import res_signup 


class signup_ui_form(object):
        
    def setupUi(self, SignupUi_Form):
      

        SignupUi_Form.setObjectName("SignupUi_Form")
        SignupUi_Form.resize(625, 565)
        self.widget = QtWidgets.QWidget(SignupUi_Form)
        self.widget.setGeometry(QtCore.QRect(30, 30, 550, 500))
        SignupUi_Form.setWindowFlags(QtCore.Qt.FramelessWindowHint)
        SignupUi_Form.setAttribute(QtCore.Qt.WA_TranslucentBackground)
...
"padding-bottom:7px;")
        ...
        self.retranslateUi(SignupUi_Form)
        QtCore.QMetaObject.connectSlotsByName(SignupUi_Form)
    
   


    def retranslateUi(self, SignupUi_Form):
        _translate = QtCore.QCoreApplication.translate
        SignupUi_Form.setWindowTitle(_translate("SignupUi_Form", "SignupUi_Form"))
        self.Signup_Header.setText(_translate("SignupUi_Form", "Welcome"))
        self.s_User.setPlaceholderText(_translate("SignupUi_Form", "Username"))
        self.s_Pass.setPlaceholderText(_translate("SignupUi_Form", " Password"))
        self.Button_Signup.setText(_translate("SignupUi_Form", "Sign up!"))
        self.s_Firstname.setPlaceholderText(_translate("SignupUi_Form", "First Name"))
        self.s_Lastname.setPlaceholderText(_translate("SignupUi_Form", "Last Name"))
        self.s_Address.setPlaceholderText(_translate("SignupUi_Form", "Address"))
        self.s_City.setPlaceholderText(_translate("SignupUi_Form", "City"))
        self.s_State.setPlaceholderText(_translate("SignupUi_Form", "State"))
        self.s_ZIP.setPlaceholderText(_translate("SignupUi_Form", "ZIP"))
        self.s_Email.setPlaceholderText(_translate("SignupUi_Form", "Email Address"))
